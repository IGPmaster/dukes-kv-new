<template>
  <div class="banner-wrapper">
    ...
    <!-- Terms and Heading Placeholders -->
    <div class="content-placeholders" :class="{ 'hidden': !loading }">
      <div class="terms-placeholder animate-pulse"></div>
      <div class="heading-placeholder animate-pulse"></div>
      <div class="trust-icons-placeholder animate-pulse"></div>
    </div>

    <!-- Actual Content -->
    <div v-show="!loading" class="content-actual">
      <!-- Your existing terms, heading, and trust icons -->
    </div>
  </div>
</template>
    ...
    try {
        ...
        if (cachedContent) {
            ...
            if (brandContent.value) {
                setCache(bannerCacheKey.value, brandContent.value, 15);
