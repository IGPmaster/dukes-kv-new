          ...
          <div class="p-6 flex-grow flex flex-col justify-between">
            ...
            <div class="flex items-center justify-between mt-4">
              <NuxtLink 
                ...
                class="inline-flex items-center justify-center px-6 py-2 border border-transparent text-sm text-gray-100 font-medium rounded-md bg-secondary hover:bg-secondary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary transition-colors duration-200"
              >
                <TranslatedText 
